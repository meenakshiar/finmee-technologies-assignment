    ...
    return (
        <section className="service_section" id="about">
            ...
            <div className="service__container container grid">
                ...
                <img src={'https://ntwist.com/wp-content/uploads/2023/01/iStock-1339284457-2048x1365.jpg'} alt="" className="service__img" />
            </div>

            {/* Service section 2 */}
            <div className="service__container container grid">
                <img src={'https://ntwist.com/wp-content/uploads/2021/12/iStock-1284372575.jpg'} alt="" className="service__img" />
                <div className="service__data">
            ...
            <div className="service__container container grid">
                ...
                <img src={'https://ntwist.com/wp-content/uploads/2021/12/iStock-1322302283.jpg'} alt="" className="service__img" />
            </div>

            {/* Service section 4 */}
            <div className="service__container container grid">
                <img src={'https://ntwist.com/wp-content/uploads/2022/03/2021-02-oil-and-gas-digital-hero-e1648984580884.png'} alt="" className="service__img" />
                <div className="service__data">
                    <h1>Oil & Gas</h1>
                    <p className="service__description">
